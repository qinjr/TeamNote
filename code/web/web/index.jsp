                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu">
                            ...
                            <a class="dropdown-item" href="#" style="color: #D0021B">
                                <i class="fa fa-exclamation-triangle fa-fw" aria-hidden="true"></i>&nbsp;登出
                            </a>
                        </div>
                    </li>
                </ul>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="row">
                                <div class="col-md-2 text-center mx-auto">
                                    <img src="image/cell_1.png" style="height: 60px; width: 60px;">
                                    <br><br>
                                    <button class="btn btn-outline-secondary center-block" type="button" style="width: 60px;">
                                        <i class="fa fa-star fa-1x" aria-hidden="true"></i>
                                        <br>
                                        <span class="align-middle">22</span>
                                    </button>
                                    <br><br>
                                    <button class="btn btn-outline-secondary center-block" type="button" style="width: 60px; height: 60px;">
                                        <i class="fa fa-flag fa-1x" aria-hidden="true"></i>
                                    </button>
                                </div>
                                <div class="col-md-10">
                                    <h4 class="card-title">Card title</h4>
                                    <h6 class="card-subtitle mb-2 text-muted">机器学习 · Logistic 回归</h6>
                                    <p class="card-text" style="word-break:break-all;">
                                        dsehfskfjenlsjfbulsbfel;nfels;fnelbuowufeouw8shfkehsleslfjeslfisjfelsjejjslfjeslfjesifejlfslfesifjslejlelfjsesfjelsfjeslfijesldsehfskfjenlsjfbulsbfel;nfels;fnelbuowufeouw8shfkehsleslfjeslfisjfelsjejjslfjeslfjesifejlfslfesifjslejlelfjsesfjelsfjeslfijesl
                                    </p>
                                    <footer>
